---
extensions:
  - name: "ZIP File Format (1998)"
    description: "ZIP File Format (1998)"
    categories:
    - archive
    author: "PKWARE Inc."
    file: zip_form.zip_

  - name: "ZIP File Format Specification version 4.5"
    description: "ZIP File Format Specification version 4.5"
    categories:
    - archive
    author: "PKWARE Inc."
    file: zip45.zip

  - name: "ZIP File Format Specification version 6.3.0"
    description: "ZIP File Format Specification version 6.3.0"
    categories:
    - archive
    author: "PKWARE Inc."
    file: zip63.zip
...
books, OpenDocument files, Android packages, and browser extensions. That broad
reuse makes ZIP one of the most important formats to understand when preserving,
repairing, or inspecting modern files.
...
The central directory near the end of the file acts as the authoritative index:
it records names, offsets, sizes, compression methods, timestamps, comments,
extra fields, and other metadata needed by readers.
...
directory record. Empty archives may contain only the end record.
...
compressed sizes, or archive offsets exceed classic 32-bit limits. Older tools
may reject ZIP64 archives or silently mishandle them.
